...
window.addEventListener('DOMContentLoaded', function () {
  ...
  player.init();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item').init(); // Другой синтаксис вызова класса, используется тогда, когда в будущем такой объект не используется
});
...
function (_Slider) {
  ...
  function MainSlider(btns) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns)); // Получаем свойства из класса Slider
  }
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTriggers() {
      ...
      }); // Переносим первый слайд в конец при нажатии на кнопку вперед
      ...
      this.prev.addEventListener('click', function () {
        for (var i = _this2.slides.length - 1; i > 0; i--) {
          if (_this2.slides[i].tagName !== 'BUTTON') {
            ...
            _this2.container.insertBefore(active, _this2.slides[0]); // Поместить active перед первым элементом
